...
CREATE TABLE "users" (
	...
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"GDPR_Agreement" boolean DEFAULT false,
...
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_UserID_users_UserID_fk" FOREIGN KEY ("UserID") REFERENCES "public"."users"("UserID") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_ReportedUserID_users_UserID_fk" FOREIGN KEY ("ReportedUserID") REFERENCES "public"."users"("UserID") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_TeamID_teams_TeamID_fk" FOREIGN KEY ("TeamID") REFERENCES "public"."teams"("TeamID") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
