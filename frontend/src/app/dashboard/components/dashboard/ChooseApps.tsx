            ...
            <form className="flex flex-col" onSubmit={(e) => { { e.preventDefault(); getBoth() } }}>
                <div className="flex flex-row gap-15">
                    <div className="flex flex-col">
                        ...
                        <label htmlFor="githubRepo" className="text-sm text-center">*Ensure the Repo is public</label>
                        <input className=' bg-gray-300 p-2 rounded-full' type='text' name='githubRepo' placeholder="Enter Repository URL" value={githubRepoUrl} onChange={(e) => setGithubRepoUrl(e.target.value)}></input>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <input className=' bg-gray-300 p-2 rounded-full' type='text' name='githubRepo' placeholder="Enter Repository URL" value={trelloBoardUrl} onChange={(e) => setTrelloBoardUrl(e.target.value)}></input>
                    </div>
                </div>
                <button className="flex justify-center pt-5" type="submit">Submit</button>
            </form>
